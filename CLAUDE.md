...
- Basi (D007): Light / Standard / Pro; la Standard è in sviluppo. `bom/base.html` = BOM Standard, `bom/base-light.html` = BOM Light Core (D024, prezzi TARGET a lotto da 50, tetto €1.050), `bom/base-pro.html` = BOM Pro (non in sviluppo attivo).
