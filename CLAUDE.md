...
- Calcoli di progetto in `tools/calc/` (D015 guide, D016 ToolDock, D017 potenza, D028 cedevolezza della Standard: `compliance_d028.py`, rigenera `base/compliance-d028.html`): se cambiano gli input, rilancia lo script e aggiorna la pagina che ne riporta i risultati.
