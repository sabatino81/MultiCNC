(()=> {
  ...
  const TREE=[
    ...
    ['02','Basi · Standard',[
      ...
      ['Pezzi Standard','base/cad-parts.html'],
      ['Assieme Light Core','base/cad-light.html'],
      ['Pezzi Light Core','base/cad-light-parts.html'],
      ['Assieme Pro','base/cad-pro.html'],
      ['Pezzi Pro','base/cad-pro-parts.html'],
