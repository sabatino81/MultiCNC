...
("MC-Z-001","Structure","Slitta Z","1",1,"Custom Al 12 mm, 150 × 160 a canale con ali anteriori 10 × 35","Porta i 4 pattini HGH15CA Z e la master ToolDock (D027); ali sopra il piano del coupling (D030); massa dal CAD di dettaglio v1",70,0.95,"M","design","CAD v1"),
...
("MC-XC-001","Structure","Carrello X","1",1,"Custom Al 15 mm, 170 × 530 + torre, a canale con ali anteriori 10 × 45","Porta pattini X, guide Z, vite, supporti e motore Z (D027); ali fuori dalla slitta e dal corridoio di docking (D030); massa dal CAD di dettaglio v1",110,3.28,"M","design","CAD v1"),
