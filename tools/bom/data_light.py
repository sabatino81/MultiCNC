...
("ML-BAS-001","Structure","Telaio basamento","1",1,"Profilati Al 40×60 a scala, pad e sedi lavorati in lotto","Sedi guide Y lavorate; 40×60 invece di 40×40 per tenere asse Y e staffa chiocciola dentro il telaio (CAD v1, D035)",80,5.22,"M","design","CAD v1"),
("ML-GAN-001","Structure","Trave gantry","1",1,"Trave Al 50×120 con canale vite, lavorata in lotto","Ponte fisso (D006); il canale contiene BK10/BF10 fra le guide X a 104 mm (CAD v1, D035)",35,2.38,"M","design","CAD v1"),
("ML-GAN-002","Structure","Spalle gantry","2",2,"Al 5083 6 mm, taglio + lavorazione in lotto","Ai lati della trave, flangia ICD §5 spinata al telaio (rialzi +50, D007); motore X sulla spalla destra (CAD v1, D035)",15,0.9,"M","design","CAD v1"),
("ML-Z-001","Structure","Piastra asse Z","1",1,"Al 5083 8 mm","Guide Z + master ToolDock",18,0.49,"M","design","CAD v1"),
("ML-XC-001","Structure","Carrello X","1",1,"Al 8 mm, piastra + torre + ali","Porta pattini X, guide Z, vite, supporti e motore Z; dal CAD di dettaglio v1 (D035)",22,1.86,"M","design","CAD v1"),
("ML-BRK-001","Structure","Staffe chiocciole, motori e supporti","1 set",1,"Custom Al, 7 pezzi","Staffe chiocciola X e Y, piastrina chiocciola Z, staffa motore Z, spessori BK/BF X, piastre ponte BK/BF Z (CAD di dettaglio v1, D035)",8,0.8,"M","design","CAD v1"),
...
("ML-BS-1204Y","Y","Ball screw Y","1",1,"SFU1204 C7 rullata","Vite singola centrale sotto la tavola (D006), 480 mm totali (CAD v1: 8 mm fra staffa e BK a fine corsa)",22,0.62,"M","validate","TO VALIDATE"),
...
("ML-SP-003","Spindle","Spindle mount","1",1,"Custom machined clamp","Receiver-compatible con ToolDock",12,0.33,"M","design","CAD v1"),
...
("ML-TD-001","ToolDock","Master kinematic plate","1",1,"Stesso accoppiamento a 3 sfere e pull-stud delle altre basi","Montata sul carrello Z; sedi già lavorate per clamp automatico, connettore ibrido e connettore dati del Platform Pack",60,0.61,"M","critical","CRITICAL DESIGN"),
