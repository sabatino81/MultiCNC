...
("MP-BAS-001","Structure","Basamento lavorato","1",1,"Scala in tubi Al 80×60 sp. 5 + fondo 5 mm (nervato), saldata e lavorata","Sedi guide Y e riferimenti lavorati; traversa posteriore lunga sotto i montanti del lift (CAD v1, D035)",250,16.08,"M","design","CAD v1"),
("MP-GAN-001","Structure","Trave gantry","1",1,"Custom box / ribbed Al","Ponte fisso (D006), sezione scatolata, predisposta Gantry Lift",160,6.98,"M","design","CAD v1"),
("MP-GAN-002","Structure","Spalle gantry","2",2,"Custom Al 16 mm + traversa superiore","Montanti del Gantry Lift dietro la trave, flangia ICD §5 sul basamento; portano guide, viti, cinghia e motore G (CAD v1, D035)",60,4.12,"M","design","CAD v1"),
("MP-Z-001","Structure","Piastra asse Z","1",1,"Custom Al 5083 15–20 mm","Guide Z + ToolDock master",80,1.41,"M","design","CAD v1"),
("MP-XC-001","Structure","Carrello X","1",1,"Al 16 mm, piastra + torre + ali","Porta pattini X, guide Z, vite, supporti e motore Z; dal CAD di dettaglio v1 (D035)",120,5.78,"M","design","CAD v1"),
("MP-BRK-001","Structure","Staffe chiocciole, motori e supporti","1 set",1,"Custom Al, 7 pezzi","Staffe chiocciola X e Y, piastrina chiocciola Z, staffa motore Z, spessori BK/BF X, piastre ponte BK/BF Z (CAD di dettaglio v1, D035)",45,0.84,"M","design","CAD v1"),
...
("MP-BS-1605X","X","Ball screw X","1",1,"SFU1605 C7 precaricata","590 mm totali (D019); precarico/errore passo da qualificare",55,1.28,"M","validate","TO VALIDATE"),
("MP-BS-1605Y","Y","Ball screw Y","1",1,"SFU1605 C7 precaricata","Vite singola centrale sotto la tavola (D006), 490 mm totali (D019)",55,1.12,"M","validate","TO VALIDATE"),
("MP-BS-1204Z","Z","Ball screw Z","1",1,"SFU1204 C7","260 mm totali (D019)",45,0.43,"M","validate","TO VALIDATE"),
...
("MP-GL-BS","Gantry Lift","Viti sollevamento","2",2,"SFU1605 class","Sollevamento sincronizzato, non asse di taglio; 350 mm totali",40,0.9,"M","design","TO DESIGN"),
...
("MP-GL-LOCK","Gantry Lift","Locking + references","1 set",1,"Custom clamp / wedge / dowel","Scarica il lift durante la lavorazione",100,2.93,"M","critical","CRITICAL DESIGN"),
]),
("D · Spindle base",[
...
("MC-TD-001","ToolDock","Master kinematic plate","1",1,"Stessa parte della Standard","Montata sul carrello Z",150,0.99,"M","critical","CRITICAL DESIGN"),
