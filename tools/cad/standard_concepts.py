...
CONCEPTS = {
    ...
    "C3c": dict(desc="C3c · C1b + connettore a uscita laterale, receiver 15 (braccio ~203 mm) · structural reference only, requires ICD v5 packaging resolution", over={"MONOCOQUE": dict(h=60.0, wall=6.0), "SADDLE": None,
