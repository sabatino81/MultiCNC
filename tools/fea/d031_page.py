...
<section class="metric-grid">
  ...
  <div class="metric"><strong>{it(dmax * 100, 1)}%</strong><span>variazione alla punta con la mesh −30% · limite 5%</span></div>
