...
<section class="section split">
  <div class="panel"><span class="kicker">Concept C · ToolDock challenger</span><h2>Diametro sì, preload poco, braccio sì.</h2><p>Base A1s. Diametro e preload separati: il preload da 1,6 a 2,4 kN su Ø80 (C1p) compra ~4% in Y, perché la rigidezza di contatto cresce solo con la radice cubica del precarico; Ø100 (C1a) +19%, Ø110 (C1b) +25%. Un receiver più sottile che deve portare le sfere su Ø110 fino al mount da 56 mm peggiora (C2, receiver 8 mm: la testa sale al 43% dell'energia in Y). Accorciare il braccio coupling → dado con il connettore a uscita laterale e receiver da 15 mm (C3c, 220 → 203 mm) porta il gantry a 1,22 / 1,02 N/µm in X / Y: la migliore variante, macchina ~1,15 / 0,85 N/µm, δXY a 80 N ~94 µm. Dopo C3c l'energia in Y è di nuovo distribuita (carrello 20%, ToolDock 19%, testa 19%, trave 15%, slitta + master 11%).</p><p><b>Costo di ingombro</b>: con receiver e inviluppo testa larghi 116–126 mm (oltre i 110 della ICD v4) l'inviluppo della testa tocca il volume della catena Y a X massimo con Z giù (FAIL con Ø110, WARNING 5 mm con Ø100) e il trasferitore passa a 2 mm dal carrello (7 mm con Ø100): si risolve spostando catena Y (~13 mm) e corridoio del trasferitore (~6 mm), non è un limite di rigidezza, ma è un costo di packaging dell'ICD v5 da mettere in conto.</p></div>
</section>
